...
Vizi.Object.prototype.findNodes=function(a){var b=this,c=[];this.traverse(function(d){b.findCallback(d,a,c)});return c};Vizi.Object.prototype.map=function(a,b){var c=this.findNodes(a),d,e=c.length;for(d=0;d<e;d++)b(c[d])};Vizi.Keyboard=function(){Vizi.Keyboard.instance=this};Vizi.Keyboard.prototype.onKeyDown=function(a){};Vizi.Keyboard.prototype.onKeyUp=function(a){};Vizi.Keyboard.prototype.onKeyPress=function(a){};Vizi.Keyboard.instance=null;Vizi.Keyboard.KEY_LEFT=37;Vizi.Keyboard.KEY_UP=38;Vizi.Keyboard.KEY_RIGHT=39;Vizi.Keyboard.KEY_DOWN=40;Vizi.Component=function(a){Vizi.EventDispatcher.call(this);this._object=null;this._realized=!1};goog.inherits(Vizi.Component,Vizi.EventDispatcher);Vizi.Component.prototype.getObject=function(){return this._object};Vizi.Component.prototype.setObject=function(a){this._object=a};Vizi.Component.prototype.realize=function(){this._realized=!0};Vizi.Component.prototype.update=function(){};Vizi.Script=function(a){a=a||{};Vizi.Component.call(this,a)};goog.inherits(Vizi.Script,Vizi.Component);Vizi.Script.prototype._componentCategory="scripts";Vizi.Script.prototype.realize=function(){Vizi.Component.prototype.realize.call(this)};Vizi.Script.prototype.update=function(){Vizi.Script.WARN_ON_ABSTRACT&&Vizi.System.warn("Abstract Script.evaluate called")};Vizi.Script.WARN_ON_ABSTRACT=!0;Vizi.Prefabs={};Vizi.Prefabs.FirstPersonController=function(a){a=a||{};var b=new Vizi.Object(a),c=new Vizi.FirstPersonControllerScript(a);b.addComponent(c);a=new Vizi.DirectionalLight({intensity:a.headlight?1:0});b.addComponent(a);return b};
Vizi.FirstPersonControllerScript=function(a){Vizi.Script.call(this,a);this._enabled=void 0!==a.enabled?a.enabled:!0;this._move=void 0!==a.move?a.move:!0;this._look=void 0!==a.look?a.look:!0;this._mouseLook=void 0!==a.mouseLook?a.mouseLook:!1;this.collisionDistance=10;this.moveSpeed=13;this.savedCameraPos=new THREE.Vector3;this.movementVector=new THREE.Vector3;Object.defineProperties(this,{camera:{get:function(){return this._camera},set:function(a){this.setCamera(a)}},enabled:{get:function(){return this._enabled},
set:function(a){this.setEnabled(a)}},move:{get:function(){return this._move},set:function(a){this.setMove(a)}},look:{get:function(){return this._look},set:function(a){this.setLook(a)}},mouseLook:{get:function(){return this._mouseLook},set:function(a){this.setMouseLook(a)}},headlightOn:{get:function(){return this._headlightOn},set:function(a){this.setHeadlightOn(a)}}})};goog.inherits(Vizi.FirstPersonControllerScript,Vizi.Script);
Vizi.FirstPersonControllerScript.prototype.realize=function(){this.headlight=this._object.getComponent(Vizi.DirectionalLight);this.headlight.intensity=this._headlightOn?1:0};Vizi.FirstPersonControllerScript.prototype.createControls=function(a){a=new Vizi.FirstPersonControls(a.object,Vizi.Graphics.instance.container);a.mouseLook=this._mouseLook;a.movementSpeed=this._move?this.moveSpeed:0;a.lookSpeed=this._look?1:0;this.clock=new THREE.Clock;return a};
...
Vizi.FirstPersonControllerScript.prototype.setCamera=function(a){this._camera=a;this.controls=this.createControls(a);this.controls.movementSpeed=this.moveSpeed;this.controls.lookSpeed=0.1};Vizi.FirstPersonControllerScript.prototype.saveCamera=function(){this.savedCameraPos.copy(this._camera.position)};Vizi.FirstPersonControllerScript.prototype.restoreCamera=function(){this._camera.position.copy(this.savedCameraPos)};
...
Vizi.Timer.prototype.stop=function(){this.running=!1};Vizi.SceneComponent=function(a){a=a||{};Vizi.Component.call(this,a);Object.defineProperties(this,{position:{get:function(){return this.object.position}},rotation:{get:function(){return this.object.rotation}},scale:{get:function(){return this.object.scale}},quaternion:{get:function(){return this.object.quaternion}},useQuaternion:{get:function(){return this.object.useQuaternion},set:function(a){this.object.useQuaternion=a}},visible:{get:function(){return this.object.visible},set:function(a){this.object.visible=
a}}});this.layer=a.layer};goog.inherits(Vizi.SceneComponent,Vizi.Component);Vizi.SceneComponent.prototype.realize=function(){this.object&&!this.object.data&&this.addToScene();Vizi.Component.prototype.realize.call(this)};Vizi.SceneComponent.prototype.update=function(){Vizi.Component.prototype.update.call(this)};
...
Vizi.SceneComponent.prototype.removeFromScene=function(){var a=this.layer?this.layer.scene:Vizi.Graphics.instance.scene;this._object&&(a=this._object.transform?this._object.transform.object:a)&&(this.object.data=null,a.remove(this.object))};Vizi.Transform=function(a){a=a||{};Vizi.SceneComponent.call(this,a);this.object=a.object?a.object:new THREE.Object3D};goog.inherits(Vizi.Transform,Vizi.SceneComponent);Vizi.Transform.prototype._componentProperty="transform";Vizi.Transform.prototype._componentPropertyType="Transform";
...
Vizi.Light.DEFAULT_COLOR=16777215;Vizi.Light.DEFAULT_INTENSITY=1;Vizi.Light.DEFAULT_RANGE=1E4;Vizi.PointLight=function(a){a=a||{};Vizi.Light.call(this,a);this.positionVec=new THREE.Vector3;this.object=a.object?a.object:new THREE.PointLight(a.color,a.intensity,void 0!==a.distance?a.distance:Vizi.PointLight.DEFAULT_DISTANCE);Object.defineProperties(this,{distance:{get:function(){return this.object.distance},set:function(a){this.object.distance=a}}})};goog.inherits(Vizi.PointLight,Vizi.Light);Vizi.PointLight.prototype.realize=function(){Vizi.Light.prototype.realize.call(this)};
Vizi.PointLight.prototype.update=function(){this.object&&(this.positionVec.set(0,0,0),this.positionVec.applyMatrix4(this.object.parent.matrixWorld),this.position.copy(this.positionVec));Vizi.Light.prototype.update.call(this)};Vizi.PointLight.DEFAULT_DISTANCE=0;Vizi.Visual=function(a){a=a||{};Vizi.SceneComponent.call(this,a);a.object?(this.object=a.object,this.geometry=this.object.geometry,this.material=this.object.material):(this.geometry=a.geometry,this.material=a.material)};goog.inherits(Vizi.Visual,Vizi.SceneComponent);Vizi.Visual.prototype._componentCategory="visuals";
Vizi.Visual.prototype.realize=function(){Vizi.SceneComponent.prototype.realize.call(this);!this.object&&(this.geometry&&this.material)&&(this.object=new THREE.Mesh(this.geometry,this.material),this.addToScene())};Vizi.SceneVisual=function(a){a=a||{};Vizi.Visual.call(this,a);this.object=a.scene};goog.inherits(Vizi.SceneVisual,Vizi.Visual);Vizi.SceneVisual.prototype.realize=function(){Vizi.Visual.prototype.realize.call(this);this.addToScene()};Vizi.Graphics=function(){if(Vizi.Graphics.instance)throw Error("Graphics singleton already exists");Vizi.Graphics.instance=this};Vizi.Graphics.instance=null;Vizi.MoveBehavior=function(a){a=a||{};this.duration=void 0!==a.duration?a.duration:1;this.moveVector=void 0!==a.moveVector?a.moveVector:new THREE.Vector3(0,1,0);this.tween=null;Vizi.Behavior.call(this,a)};goog.inherits(Vizi.MoveBehavior,Vizi.Behavior);
...
Vizi.PickManager.handleMouseMove=function(a){if(Vizi.PickManager.clickedObject&&Vizi.PickManager.clickedObject.onMouseMove)Vizi.PickManager.clickedObject.onMouseMove(a);else{var b=Vizi.PickManager.overObject;Vizi.PickManager.overObject=Vizi.PickManager.objectFromMouse(a);Vizi.PickManager.overObject!=b&&(b&&(Vizi.Graphics.instance.setCursor(null),b.onMouseOut&&(a.type="mouseout",b.onMouseOut(a))),Vizi.PickManager.overObject&&(Vizi.PickManager.overObject.overCursor&&Vizi.Graphics.instance.setCursor(Vizi.PickManager.overObject.overCursor),Vizi.PickManager.overObject.onMouseOver&&
(a.type="mouseover",Vizi.PickManager.overObject.onMouseOver(a))))}};Vizi.PickManager.handleMouseDown=function(a){Vizi.PickManager.clickedObject=Vizi.PickManager.objectFromMouse(a);if(Vizi.PickManager.clickedObject&&Vizi.PickManager.clickedObject.onMouseDown)Vizi.PickManager.clickedObject.onMouseDown(a)};Vizi.PickManager.handleMouseUp=function(a){if(Vizi.PickManager.clickedObject&&Vizi.PickManager.clickedObject.onMouseUp)Vizi.PickManager.clickedObject.onMouseUp(a);Vizi.PickManager.clickedObject=null};
Vizi.PickManager.handleMouseClick=function(a){Vizi.PickManager.clickedObject=Vizi.PickManager.objectFromMouse(a);if(Vizi.PickManager.clickedObject&&Vizi.PickManager.clickedObject.onMouseClick)Vizi.PickManager.clickedObject.onMouseClick(a);Vizi.PickManager.clickedObject=null};
Vizi.PickManager.handleMouseDoubleClick=function(a){Vizi.PickManager.clickedObject=Vizi.PickManager.objectFromMouse(a);if(Vizi.PickManager.clickedObject&&Vizi.PickManager.clickedObject.onMouseDoubleClick)Vizi.PickManager.clickedObject.onMouseDoubleClick(a);Vizi.PickManager.clickedObject=null};Vizi.PickManager.handleMouseScroll=function(a){if(Vizi.PickManager.overObject&&Vizi.PickManager.overObject.onMouseScroll)Vizi.PickManager.overObject.onMouseScroll(a);Vizi.PickManager.clickedObject=null};
Vizi.PickManager.handleTouchStart=function(a){if(0<a.touches.length&&(a.screenX=a.touches[0].screenX,a.screenY=a.touches[0].screenY,a.clientX=a.touches[0].clientX,a.clientY=a.touches[0].clientY,a.pageX=a.touches[0].pageX,a.pageY=a.touches[0].pageY,a.elementX=a.touches[0].elementX,a.elementY=a.touches[0].elementY,Vizi.PickManager.clickedObject=Vizi.PickManager.objectFromMouse(a),Vizi.PickManager.clickedObject&&Vizi.PickManager.clickedObject.onTouchStart))Vizi.PickManager.clickedObject.onTouchStart(a)};
Vizi.PickManager.handleTouchMove=function(a){if(0<a.touches.length&&(a.screenX=a.touches[0].screenX,a.screenY=a.touches[0].screenY,a.clientX=a.touches[0].clientX,a.clientY=a.touches[0].clientY,a.pageX=a.touches[0].pageX,a.pageY=a.touches[0].pageY,a.elementX=a.touches[0].elementX,a.elementY=a.touches[0].elementY,Vizi.PickManager.clickedObject&&Vizi.PickManager.clickedObject.onTouchMove))Vizi.PickManager.clickedObject.onTouchMove(a)};
Vizi.PickManager.handleTouchEnd=function(a){if(0<a.changedTouches.length){a.screenX=a.changedTouches[0].screenX;a.screenY=a.changedTouches[0].screenY;a.clientX=a.changedTouches[0].clientX;a.clientY=a.changedTouches[0].clientY;a.pageX=a.changedTouches[0].pageX;a.pageY=a.changedTouches[0].pageY;a.elementX=a.changedTouches[0].elementX;a.elementY=a.changedTouches[0].elementY;if(Vizi.PickManager.clickedObject&&Vizi.PickManager.clickedObject.onTouchEnd)Vizi.PickManager.clickedObject.onTouchEnd(a);Vizi.PickManager.clickedObject=
null}};Vizi.PickManager.objectFromMouse=function(a){var b=Vizi.Graphics.instance.objectFromMouse(a);return b.object?(a.normal=b.normal,a.point=b.point,a.object=b.object,b.object._object.picker&&b.object._object.picker.enabled?b.object._object.picker:Vizi.PickManager.findObjectPicker(b.object.object)):null};Vizi.PickManager.findObjectPicker=function(a){for(;a;){if(a.data&&a.data._object.picker&&a.data._object.picker.enabled)return a.data._object.picker;a=a.parent}return null};
Vizi.PickManager.clickedObject=null;Vizi.PickManager.overObject=null;Vizi.AmbientLight=function(a){a=a||{};Vizi.Light.call(this,a);this.object=a.object?a.object:new THREE.AmbientLight(a.color)};goog.inherits(Vizi.AmbientLight,Vizi.Light);Vizi.AmbientLight.prototype.realize=function(){Vizi.Light.prototype.realize.call(this)};Vizi.Input=function(){this.mouse=new Vizi.Mouse;this.keyboard=new Vizi.Keyboard;Vizi.Input.instance=this};goog.inherits(Vizi.Input,Vizi.Service);Vizi.Input.instance=null;Vizi.RotateBehavior=function(a){a=a||{};this.duration=void 0!==a.duration?a.duration:1;this.velocity=void 0!==a.velocity?a.velocity:Math.PI/2/this.duration;this.angle=this.startAngle=0;Vizi.Behavior.call(this,a)};goog.inherits(Vizi.RotateBehavior,Vizi.Behavior);Vizi.RotateBehavior.prototype.start=function(){this.angle=0;this._object.transform.rotation.y%=2*Math.PI;this.startAngle=this._object.transform.rotation.y;Vizi.Behavior.prototype.start.call(this)};
Vizi.RotateBehavior.prototype.evaluate=function(a){var b=2*Math.PI;this.angle=this.velocity*a;this.angle>=b&&(this.angle=this.once?b:this.angle%b);this._object.transform.rotation.y=this.startAngle+this.angle;this.once&&this.angle>=b&&this.stop()};Vizi.FirstPersonControls=function(a,b){function c(a,b){return function(){b.apply(a,arguments)}}this.object=a;this.target=new THREE.Vector3(0,0,0);this.domElement=void 0!==b?b:document;this.lookSpeed=this.movementSpeed=1;this.touchScreenY=this.touchScreenX=this.lastMouseY=this.lastMouseX=this.mouseY=this.mouseX=0;this.moveTouchId=this.lookTouchId=-1;this.theta=this.phi=this.lon=this.lat=0;this.mouseLook=this.mouseDragOn=this.moveRight=this.moveLeft=this.moveBackward=this.moveForward=!1;this.viewHalfY=
this.viewHalfX=0;this.domElement!==document&&this.domElement.setAttribute("tabindex",-1);this.handleResize=function(){this.domElement===document?(this.viewHalfX=window.innerWidth/2,this.viewHalfY=window.innerHeight/2):(this.viewHalfX=this.domElement.offsetWidth/2,this.viewHalfY=this.domElement.offsetHeight/2)};this.onMouseDown=function(a){this.domElement===document?(this.mouseX=a.pageX-this.viewHalfX,this.mouseY=a.pageY-this.viewHalfY):(this.mouseX=a.pageX-this.domElement.offsetLeft-this.viewHalfX,
this.mouseY=a.pageY-this.domElement.offsetTop-this.viewHalfY);this.lastMouseX=this.mouseX;this.lastMouseY=this.mouseY;this.mouseDragOn=!0};this.onMouseUp=function(a){this.mouseDragOn=!1};this.onMouseMove=function(a){this.domElement===document?(this.mouseX=a.pageX-this.viewHalfX,this.mouseY=a.pageY-this.viewHalfY):(this.mouseX=a.pageX-this.domElement.offsetLeft-this.viewHalfX,this.mouseY=a.pageY-this.domElement.offsetTop-this.viewHalfY)};this.onTouchStart=function(a){a.preventDefault();0<a.touches.length&&
(-1==this.lookTouchId?(this.lookTouchId=a.touches[0].identifier,this.onMouseDown({type:"mousedown",view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:a.touches[0].screenX,screenY:a.touches[0].screenY,clientX:a.touches[0].clientX,clientY:a.touches[0].clientY,pageX:a.touches[0].pageX,pageY:a.touches[0].pageY,button:0,preventDefault:a.preventDefault})):(this.touchScreenX=a.touches[1].screenX,this.touchScreenY=a.touches[1].screenY,this.moveTouchId=a.touches[1].identifier))};
this.onTouchMove=function(a){a.preventDefault();for(var b=null,c=null,h=a.changedTouches.length,k=0;k<h;k++)a.changedTouches[k].identifier==this.lookTouchId&&(b=a.changedTouches[k]),a.changedTouches[k].identifier==this.moveTouchId&&(c=a.changedTouches[k]);if(b)this.onMouseMove({type:"mousemove",view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:b.screenX,screenY:b.screenY,clientX:b.clientX,clientY:b.clientY,pageX:b.pageX,pageY:b.pageY,button:0,preventDefault:a.preventDefault});
c&&(a=c.screenX-this.touchScreenX,b=c.screenY-this.touchScreenY,this.touchScreenX=c.screenX,this.touchScreenY=c.screenY,0<a&&(this.moveRight=!0),0>a&&(this.moveLeft=!0),0<b&&(this.moveBackward=!0),0>b&&(this.moveForward=!0))};this.onTouchEnd=function(a){a.preventDefault();for(var b=null,c=null,h=a.changedTouches.length,k=0;k<h;k++)a.changedTouches[k].identifier==this.lookTouchId&&(b=a.changedTouches[k]),a.changedTouches[k].identifier==this.moveTouchId&&(c=a.changedTouches[k]);b&&(this.onMouseUp({type:"mouseup",
view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:b.screenX,screenY:b.screenY,clientX:b.clientX,clientY:b.clientY,pageX:b.pageX,pageY:b.pageY,button:0,preventDefault:a.preventDefault}),this.lookTouchId=-1);c&&(this.touchScreenX=c.screenX,this.touchScreenY=c.screenY,this.moveForward=this.moveBackward=this.moveLeft=this.moveRight=!1,this.moveTouchId=-1)};this.onKeyDown=function(a){switch(a.keyCode){case 38:case 87:this.moveForward=!0;break;case 37:case 65:this.moveLeft=!0;
break;case 40:case 83:this.moveBackward=!0;break;case 39:case 68:this.moveRight=!0;break;case 82:this.moveUp=!0;break;case 70:this.moveDown=!0}};this.onKeyUp=function(a){switch(a.keyCode){case 38:case 87:this.moveForward=!1;break;case 37:case 65:this.moveLeft=!1;break;case 40:case 83:this.moveBackward=!1;break;case 39:case 68:this.moveRight=!1;break;case 82:this.moveUp=!1;break;case 70:this.moveDown=!1}};this.update=function(a){this.startY=this.object.position.y;a*=this.movementSpeed;this.moveForward&&
this.object.translateZ(-a);this.moveBackward&&this.object.translateZ(a);this.moveLeft&&this.object.translateX(-a);this.moveRight&&this.object.translateX(a);this.object.position.y=this.startY;if(this.mouseDragOn||this.mouseLook){a=this.lastMouseX-this.mouseX;Math.abs(a);this.lon+=900*(a/this.viewHalfX)*this.lookSpeed;a=this.lastMouseY-this.mouseY;Math.abs(a);this.lat+=900*(a/this.viewHalfY)*this.lookSpeed;this.theta=THREE.Math.degToRad(this.lon);this.lat=Math.max(-85,Math.min(85,this.lat));this.phi=
THREE.Math.degToRad(this.lat);a=this.target;var b=this.object.position;a.x=b.x-Math.sin(this.theta);a.y=b.y+Math.sin(this.phi);a.z=b.z-Math.cos(this.theta);this.object.lookAt(a);this.lastMouseX=this.mouseX;this.lastMouseY=this.mouseY}};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},!1);this.domElement.addEventListener("mousemove",c(this,this.onMouseMove),!0);this.domElement.addEventListener("mousedown",c(this,this.onMouseDown),!1);this.domElement.addEventListener("mouseup",
c(this,this.onMouseUp),!1);this.domElement.addEventListener("touchstart",c(this,this.onTouchStart),!1);this.domElement.addEventListener("touchmove",c(this,this.onTouchMove),!1);this.domElement.addEventListener("touchend",c(this,this.onTouchEnd),!1);this.domElement.addEventListener("keydown",c(this,this.onKeyDown),!1);this.domElement.addEventListener("keyup",c(this,this.onKeyUp),!1);this.domElement.addEventListener("resize",c(this,this.handleResize),!1);this.handleResize()};Vizi.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*g.autoRotateSpeed}function d(a){!1!==g.enabled&&!1!==g.userRotate&&(a.preventDefault(),0===a.button||g.oneButton&&2===a.button?(m=l.ROTATE,r.set(a.clientX,a.clientY)):1===a.button&&g.userZoom?(m=l.ZOOM,s.set(a.clientX,a.clientY)):2===a.button&&g.userPan&&(m=l.PAN),g.domElement.addEventListener("mousemove",e,!1),g.domElement.addEventListener("mouseup",k,!1),g.domElement.addEventListener("touchmove",f,!1),g.domElement.addEventListener("touchend",
w,!1))}function e(a){!1!==g.enabled&&(a.preventDefault(),m===l.ROTATE?(t.set(a.clientX,a.clientY),u.subVectors(t,r),g.rotateLeft(2*Math.PI*u.x/x*g.userRotateSpeed),g.rotateUp(2*Math.PI*u.y/x*g.userRotateSpeed),r.copy(t)):m===l.ZOOM?(v.set(a.clientX,a.clientY),y.subVectors(v,s),0<y.y?g.zoomIn():g.zoomOut(),s.copy(v)):m===l.PAN&&g.pan(new THREE.Vector3(-(a.movementX||a.mozMovementX||a.webkitMovementX||0),a.movementY||a.mozMovementY||a.webkitMovementY||0,0)))}function f(a){if(1<a.changedTouches.length){for(var b=
null,c=null,d=0;d<a.changedTouches.length;d++)a.changedTouches[d].identifier==g.touchId0?b=a.changedTouches[d]:a.changedTouches[d].identifier==g.touchId1&&(c=a.changedTouches[d]);b&&c&&(a=h(b,c),b=a-g.touchDistance,0<b?g.zoomIn():0>b&&g.zoomOut(),g.touchDistance=a)}else e({type:"mousemove",view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:a.changedTouches[0].screenX,screenY:a.changedTouches[0].screenY,clientX:a.changedTouches[0].clientX,clientY:a.changedTouches[0].clientY,
pageX:a.changedTouches[0].pageX,pageY:a.changedTouches[0].pageY,button:0,preventDefault:function(){}})}function h(a,b){var c=b.clientX-a.clientX,d=b.clientY-a.clientY;return Math.sqrt(c*c+d*d)}function k(a){!1!==g.enabled&&!1!==g.userRotate&&(document.removeEventListener("mousemove",e,!1),document.removeEventListener("mouseup",k,!1),g.domElement.removeEventListener("touchmove",f,!1),g.domElement.removeEventListener("touchend",w,!1),m=l.NONE)}function w(a){1<a.changedTouches.length||k({type:"mouseup",
view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:a.changedTouches[0].screenX,screenY:a.changedTouches[0].screenY,clientX:a.changedTouches[0].clientX,clientY:a.changedTouches[0].clientY,pageX:a.changedTouches[0].pageX,pageY:a.changedTouches[0].pageY,button:0,preventDefault:function(){}})}function z(a){a.preventDefault();if(!1!==g.enabled&&!1!==g.userZoom){var b=0;a.wheelDelta?b=a.wheelDelta:a.detail&&(b=-a.detail);0<b?g.zoomIn():g.zoomOut()}}this.object=a;this.domElement=
void 0!==b?b:document;this.enabled=!0;this.center=new THREE.Vector3;this.userZoom=!0;this.userZoomSpeed=1;this.userRotate=!0;this.userRotateSpeed=1;this.userPan=!0;this.userPanSpeed=2;this.autoRotate=!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.minDistance=0;this.maxDistance=Infinity;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.oneButton=!1;var g=this,x=1800,r=new THREE.Vector2,t=new THREE.Vector2,u=new THREE.Vector2,s=new THREE.Vector2,v=new THREE.Vector2,y=
new THREE.Vector2,n=0,p=0,q=1,A=new THREE.Vector3,l={NONE:-1,ROTATE:0,ZOOM:1,PAN:2},m=l.NONE,B={type:"change"};this.rotateLeft=function(a){void 0===a&&(a=c());p-=a};this.rotateRight=function(a){void 0===a&&(a=c());p+=a};this.rotateUp=function(a){void 0===a&&(a=c());n-=a};this.rotateDown=function(a){void 0===a&&(a=c());n+=a};this.zoomIn=function(a){void 0===a&&(a=Math.pow(1/0.95,g.userZoomSpeed));q/=a};this.zoomOut=function(a){void 0===a&&(a=Math.pow(1/0.95,g.userZoomSpeed));q*=a};this.pan=function(a){a.transformDirection(this.object.matrix);
a.multiplyScalar(g.userPanSpeed);this.object.position.add(a);this.center.add(a)};this.update=function(){var a=this.object.position,b=a.clone().sub(this.center),d=Math.atan2(b.x,b.z),e=Math.atan2(Math.sqrt(b.x*b.x+b.z*b.z),b.y);this.autoRotate&&this.rotateLeft(c());var d=d+p,e=e+n,e=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,e)),e=Math.max(1E-6,Math.min(Math.PI-1E-6,e)),f=b.length()*q,f=Math.max(this.minDistance,Math.min(this.maxDistance,f));b.x=f*Math.sin(e)*Math.sin(d);b.y=f*Math.cos(e);
b.z=f*Math.sin(e)*Math.cos(d);a.copy(this.center).add(b);this.object.lookAt(this.center);n=p=0;q=1;0<A.distanceTo(this.object.position)&&(this.dispatchEvent(B),A.copy(this.object.position))};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},!1);this.domElement.addEventListener("mousedown",d,!1);this.domElement.addEventListener("touchstart",function(a){1<a.touches.length?(g.touchDistance=h(a.touches[0],a.touches[1]),g.touchId0=a.touches[0].identifier,g.touchId1=a.touches[1].identifier):
d({type:"mousedown",view:a.view,bubbles:a.bubbles,cancelable:a.cancelable,detail:a.detail,screenX:a.touches[0].screenX,screenY:a.touches[0].screenY,clientX:a.touches[0].clientX,clientY:a.touches[0].clientY,pageX:a.touches[0].pageX,pageY:a.touches[0].pageY,button:0,preventDefault:function(){}})},!1);this.domElement.addEventListener("mousewheel",z,!1);this.domElement.addEventListener("DOMMouseScroll",z,!1);this.domElement.addEventListener("keydown",function(a){if(!1!==g.enabled&&!1!==g.userPan)switch(a.keyCode){case g.keys.UP:g.pan(new THREE.Vector3(0,
1,0));break;case g.keys.BOTTOM:g.pan(new THREE.Vector3(0,-1,0));break;case g.keys.LEFT:g.pan(new THREE.Vector3(-1,0,0));break;case g.keys.RIGHT:g.pan(new THREE.Vector3(1,0,0))}},!1)};Vizi.OrbitControls.prototype=Object.create(THREE.EventDispatcher.prototype);Vizi.GraphicsThreeJS=function(){Vizi.Graphics.call(this)};goog.inherits(Vizi.GraphicsThreeJS,Vizi.Graphics);Vizi.GraphicsThreeJS.prototype.initialize=function(a){a=a||{};this.initOptions(a);this.initPageElements(a);this.initScene();this.initRenderer(a);this.initMouse();this.initKeyboard();this.addDomHandlers()};Vizi.GraphicsThreeJS.prototype.focus=function(){this.renderer&&this.renderer.domElement&&this.renderer.domElement.focus()};
...
Vizi.GraphicsThreeJS.prototype.initRenderer=function(a){var b=new THREE.WebGLRenderer({antialias:!0});b.sortObjects=!1;b.setSize(this.container.offsetWidth,this.container.offsetHeight);a&&a.backgroundColor&&(b.domElement.style.backgroundColor=a.backgroundColor,b.domElement.setAttribute("z-index",-1));this.container.appendChild(b.domElement);a=new THREE.Projector;this.renderer=b;this.projector=a;this.lastFrameTime=0};
...
point:null,normal:null}:this.findObjectFromIntersected(c.object,c.point,c.face?c.face.normal:null)}return{object:null,point:null,normal:null}};
Vizi.GraphicsThreeJS.prototype.objectFromRay=function(a,b,c,d,e){b=new THREE.Raycaster(b,c,d,e);c=null;c=a?a.transform.object.children:this.scene.children;a=b.intersectObjects(c,!0);if(0<a.length){for(b=0;b<a.length&&(!a[b].object.visible||a[b].object.ignoreCollision);)b++;c=a[b];return b>=a.length?{object:null,point:null,normal:null}:this.findObjectFromIntersected(c.object,c.point,c.face?c.face.normal:null)}return{object:null,point:null,normal:null}};
Vizi.GraphicsThreeJS.prototype.findObjectFromIntersected=function(a,b,c){if(a.data){var d=new THREE.Matrix4;d.getInverse(a.matrixWorld);var e=b.clone();b.applyMatrix4(d);return{object:a.data,point:b,hitPointWorld:e,normal:c}}return a.parent?this.findObjectFromIntersected(a.parent,b,c):{object:null,point:null,normal:null}};
...
Vizi.Application.prototype.addObject=function(a){this._objects.push(a);this.running&&a.realize()};Vizi.Application.prototype.removeObject=function(a){a=this._objects.indexOf(o);-1!=a&&this._objects.splice(a,1)};Vizi.Application.prototype.realizeObjects=function(){var a,b=this._objects.length;for(a=0;a<b;a++)this._objects[a].realize()};Vizi.Application.prototype.onMouseMove=function(a){if(this.mouseDelegate&&this.mouseDelegate.onMouseMove)this.mouseDelegate.onMouseMove(a)};
...
Vizi.ModelControllerScript=function(a){Vizi.Script.call(this,a);this.radius=a.radius||Vizi.ModelControllerScript.default_radius;this.minRadius=a.minRadius||Vizi.ModelControllerScript.default_min_radius;this.allowPan=void 0!==a.allowPan?a.allowPan:!0;this.allowZoom=void 0!==a.allowZoom?a.allowZoom:!0;this.oneButton=void 0!==a.oneButton?a.oneButton:!0;this._enabled=void 0!==a.enabled?a.enabled:!0;this._headlightOn=a.headlight;this.cameras=[];this.controlsList=[];Object.defineProperties(this,{camera:{get:function(){return this._camera},
set:function(a){this.setCamera(a)}},center:{get:function(){return this.controls.center},set:function(a){this.controls.center.copy(a)}},enabled:{get:function(){return this._enabled},set:function(a){this.setEnabled(a)}},headlightOn:{get:function(){return this._headlightOn},set:function(a){this.setHeadlightOn(a)}}})};goog.inherits(Vizi.ModelControllerScript,Vizi.Script);
Vizi.ModelControllerScript.prototype.realize=function(){this.headlight=this._object.getComponent(Vizi.DirectionalLight);this.headlight.intensity=this._headlightOn?1:0};Vizi.ModelControllerScript.prototype.createControls=function(a){a=new Vizi.OrbitControls(a.object,Vizi.Graphics.instance.container);a.userMinY=this.minY;a.userMinZoom=this.minZoom;a.userMaxZoom=this.maxZoom;a.oneButton=this.oneButton;a.userPan=this.allowPan;a.userZoom=this.allowZoom;return a};
...
Vizi.ModelControllerScript.prototype.setEnabled=function(a){this._enabled=a;this.controls.enabled=a};Vizi.ModelControllerScript.default_radius=10;Vizi.ModelControllerScript.default_min_radius=1;Vizi.ModelControllerScript.MAX_X_ROTATION=0;Vizi.ModelControllerScript.MIN_X_ROTATION=-Math.PI/2;Vizi.ModelControllerScript.MAX_Y_ROTATION=2*Math.PI;Vizi.ModelControllerScript.MIN_Y_ROTATION=2*-Math.PI;Vizi.Prefabs.Skybox=function(a){a=a||{};var b=new Vizi.Object({layer:Vizi.Graphics.instance.backgroundLayer}),c=THREE.ShaderLib.cube;c.uniforms.tCube.value=null;c=new THREE.ShaderMaterial({fragmentShader:c.fragmentShader,vertexShader:c.vertexShader,uniforms:c.uniforms,side:THREE.BackSide});c=new Vizi.Visual({geometry:new THREE.CubeGeometry(1,1,1),material:c});b.addComponent(c);a=new Vizi.SkyboxScript(a);b.addComponent(a);b.realize();return b};
...
Vizi.SkyboxScript.prototype.realize=function(){this.uniforms=this._object.getComponent(Vizi.Visual).material.uniforms;this.camera=Vizi.Graphics.instance.backgroundLayer.camera;this.camera.position.set(0,0,0)};Vizi.SkyboxScript.prototype.update=function(){var a=Vizi.Graphics.instance.camera;a.updateMatrixWorld();a.matrixWorld.decompose(this.maincampos,this.maincamrot,this.maincamscale);this.camera.quaternion.copy(this.maincamrot)};Vizi.KeyFrameAnimator=function(a){Vizi.Component.call(this,a);a=a||{};this.interpdata=a.interps||[];this.animationData=a.animations;this.running=!1;this.direction=Vizi.KeyFrameAnimator.FORWARD_DIRECTION;this.duration=a.duration?a.duration:Vizi.KeyFrameAnimator.default_duration;this.loop=a.loop?a.loop:!1};goog.inherits(Vizi.KeyFrameAnimator,Vizi.Component);
...
Vizi.KeyFrameAnimator.prototype.update=function(){if(this.running)if(this.animations)this.updateAnimations();else{var a=Date.now(),b=(a-this.startTime)%this.duration/this.duration;if(1<=Math.floor((a-this.startTime)/this.duration)&&!this.loop){this.running=!1;this.dispatchEvent("complete");for(var c=this.interps.length,a=0;a<c;a++)this.interps[a].interp(1)}else for(c=this.interps.length,a=0;a<c;a++)this.interps[a].interp(b)}};
Vizi.KeyFrameAnimator.prototype.updateAnimations=function(){var a=Date.now(),b=a-this.lastTime,c=!1,d,e=this.animations.length;for(d=0;d<e;d++)this.animations[d].update(b),!this.loop&&a>=this.endTime&&(c=!0);this.lastTime=a;c&&this.stop()};Vizi.KeyFrameAnimator.default_duration=1E3;Vizi.KeyFrameAnimator.FORWARD_DIRECTION=0;Vizi.KeyFrameAnimator.REVERSE_DIRECTION=1;Vizi.Camera=function(a){a=a||{};Vizi.SceneComponent.call(this,a);Object.defineProperties(this,{active:{get:function(){return this._active},set:function(a){this._active=a;this._realized&&this._active&&Vizi.CameraManager.setActiveCamera(this)}}});this._active=a.active||!1};goog.inherits(Vizi.Camera,Vizi.SceneComponent);Vizi.Camera.prototype._componentProperty="camera";Vizi.Camera.prototype._componentPropertyType="Camera";
Vizi.Camera.prototype.realize=function(){Vizi.SceneComponent.prototype.realize.call(this);this.addToScene();Vizi.CameraManager.addCamera(this);this._active&&Vizi.CameraManager.setActiveCamera(this)};Vizi.Camera.prototype.lookAt=function(a){this.object.lookAt(a)};Vizi.Camera.DEFAULT_POSITION=new THREE.Vector3(0,0,10);Vizi.Camera.DEFAULT_NEAR=1;Vizi.Camera.DEFAULT_FAR=1E4;Vizi.PerspectiveCamera=function(a){a=a||{};if(a.object)this.object=a.object;else{var b=a.fov||45,c=a.near||Vizi.Camera.DEFAULT_NEAR,d=a.far||Vizi.Camera.DEFAULT_FAR,e=Vizi.Graphics.instance.container,e=a.aspect||e.offsetWidth/e.offsetHeight;this.updateProjection=!1;this.object=new THREE.PerspectiveCamera(b,e,c,d)}Object.defineProperties(this,{fov:{get:function(){return this.object.fov},set:function(a){this.object.fov=a;this.updateProjection=!0}},aspect:{get:function(){return this.object.aspect},set:function(a){this.object.aspect=
...
Vizi.PerspectiveCamera.prototype.update=function(){this.updateProjection&&(this.object.updateProjectionMatrix(),this.updateProjection=!1)};Vizi.SceneUtils={};
Vizi.SceneUtils.computeBoundingBox=function(a){var b=function(a){if(a instanceof THREE.Mesh){var d=a.geometry;return d?(d.boundingBox||d.computeBoundingBox(),d=d.boundingBox.clone(),a.updateMatrix(),d.applyMatrix4(a.matrix),d):new THREE.Box3(new THREE.Vector3,new THREE.Vector3)}for(var e=a.children.length,f=new THREE.Box3,d=0;d<e;d++){var h=b(a.children[d]);h.min.x<f.min.x&&(f.min.x=h.min.x);h.max.x>f.max.x&&(f.max.x=h.max.x);h.min.y<f.min.y&&(f.min.y=h.min.y);h.max.y>f.max.y&&(f.max.y=h.max.y);h.min.z<
f.min.z&&(f.min.z=h.min.z);h.max.z>f.max.z&&(f.max.z=h.max.z)}isFinite(f.min.x)&&(a.updateMatrix(),f.applyMatrix4(a.matrix));return f};return a instanceof Vizi.Object?b(a.transform.object):new THREE.Box3(new THREE.Vector3,new THREE.Vector3)};Vizi.Picker=function(a){a=a||{};Vizi.Component.call(this,a);this.overCursor=a.overCursor;this.enabled=void 0!==a.enabled?a.enabled:!0};goog.inherits(Vizi.Picker,Vizi.Component);Vizi.Picker.prototype._componentProperty="picker";Vizi.Picker.prototype._componentPropertyType="Picker";Vizi.Picker.prototype.realize=function(){Vizi.Component.prototype.realize.call(this);this.lastHitPoint=new THREE.Vector3;this.lastHitNormal=new THREE.Vector3};Vizi.Picker.prototype.update=function(){};
Vizi.Picker.prototype.onMouseOver=function(a){this.dispatchEvent("mouseover",a)};Vizi.Picker.prototype.onMouseOut=function(a){this.dispatchEvent("mouseout",a)};Vizi.Picker.prototype.onMouseMove=function(a){Vizi.PickManager.objectFromMouse(a)==this&&(this.lastHitPoint.copy(a.point),a.normal&&this.lastHitNormal.copy(a.normal),this.dispatchEvent("mousemove",a))};
Vizi.Picker.prototype.onMouseDown=function(a){this.lastHitPoint.copy(a.point);a.normal&&this.lastHitNormal.copy(a.normal);this.dispatchEvent("mousedown",a)};Vizi.Picker.prototype.onMouseUp=function(a){Vizi.PickManager.objectFromMouse(a)!=this&&(a.point=this.lastHitPoint,a.normal=this.lastHitNormal,this.dispatchEvent("mouseout",a));this.dispatchEvent("mouseup",a)};
Vizi.Picker.prototype.onMouseClick=function(a){this.lastHitPoint.copy(a.point);a.normal&&this.lastHitNormal.copy(a.normal);this.dispatchEvent("click",a)};Vizi.Picker.prototype.onMouseDoubleClick=function(a){this.lastHitPoint.copy(a.point);a.normal&&this.lastHitNormal.copy(a.normal);this.dispatchEvent("dblclick",a)};Vizi.Picker.prototype.onMouseScroll=function(a){this.dispatchEvent("mousescroll",a)};Vizi.Picker.prototype.onTouchMove=function(a){this.dispatchEvent("touchmove",a)};
Vizi.Picker.prototype.onTouchStart=function(a){this.dispatchEvent("touchstart",a)};Vizi.Picker.prototype.onTouchEnd=function(a){this.dispatchEvent("touchend",a)};Vizi.System={log:function(){var a=["[Vizi] "].concat([].slice.call(arguments));console.log.apply(console,a)},warn:function(){var a=["[Vizi] "].concat([].slice.call(arguments));console.warn.apply(console,a)},error:function(){var a=["[Vizi] "].concat([].slice.call(arguments));console.error.apply(console,a)}};Vizi.HighlightBehavior=function(a){a=a||{};this.highlightColor=void 0!==a.highlightColor?a.highlightColor:16777215;this.savedColors=[];Vizi.Behavior.call(this,a)};goog.inherits(Vizi.HighlightBehavior,Vizi.Behavior);Vizi.HighlightBehavior.prototype.start=function(){Vizi.Behavior.prototype.start.call(this);if(this._realized&&this._object.visuals){var a=this._object.visuals,b,c=a.length;for(b=0;b<c;b++)this.savedColors.push(a[b].material.color.getHex()),a[b].material.color.setHex(this.highlightColor)}};
...
this.bounceDelta=new THREE.Vector3,this.tweenDown=(new TWEEN.Tween(this.bouncePosition)).to(this.bounceEndPosition,1E3*(this.duration/2)).easing(TWEEN.Easing.Quadratic.InOut).repeat(0).start()));a>=this.duration&&(this.tweenDown.stop(),this.tweenDown=null,this.stop(),this.loop&&this.start())};Vizi.CameraManager={};Vizi.CameraManager.addCamera=function(a){Vizi.CameraManager.cameraList.push(a)};Vizi.CameraManager.removeCamera=function(a){a=Vizi.CameraManager.cameraList.indexOf(a);-1!=a&&Vizi.CameraManager.cameraList.splice(a,1)};Vizi.CameraManager.setActiveCamera=function(a){Vizi.CameraManager.activeCamera&&(Vizi.CameraManager.activeCamera.active=!1);Vizi.CameraManager.activeCamera=a;Vizi.Graphics.instance.camera=a.object};
Vizi.CameraManager.handleWindowResize=function(a,b){var c=Vizi.CameraManager.cameraList;if(0==c.length)return!1;var d,e=c.length;for(d=0;d<e;d++)c[d].aspect=a/b;return!0};Vizi.CameraManager.cameraList=[];Vizi.CameraManager.activeCamera=null;Vizi.Loader=function(){Vizi.EventDispatcher.call(this)};goog.inherits(Vizi.Loader,Vizi.EventDispatcher);Vizi.Loader.prototype.loadModel=function(a){var b=a.split("."),c=b.length,d="";c&&(d=b[c-1]);if(d&&d.length){var e;switch(d.toUpperCase()){case "JS":e=THREE.JSONLoader}if(e){var f=this;(new e).load(a,function(b,c){f.handleModelLoaded(a,b,c)})}}};
Vizi.Loader.prototype.handleModelLoaded=function(a,b,c){a=new THREE.MeshFaceMaterial(c);a=new THREE.Mesh(b,a);b=new Vizi.Object;a=new Vizi.Visual({object:a});b.addComponent(a);this.dispatchEvent("loaded",{scene:b,cameras:[],lights:[],keyFrameAnimators:[]})};
Vizi.Loader.prototype.loadScene=function(a){var b=a.split("."),c=b.length,d="";c&&(d=b[c-1]);if(d&&d.length){var e;switch(d.toUpperCase()){case "DAE":e=THREE.ColladaLoader;break;case "JS":return this.loadModel(a);case "JSON":e=THREE.glTFLoader}if(e){var f=this;(new e).load(a,function(b){f.handleSceneLoaded(a,b)},function(b){f.handleSceneProgress(a,b)})}}};
...
Vizi.Loader.prototype.handleSceneLoaded=function(a,b){var c={},d=!1;b.scene&&(d=this.convertScene(b.scene),c.scene=d,c.cameras=d.findNodes(Vizi.Camera),c.lights=d.findNodes(Vizi.Light),d=!0);if(b.animations){c.keyFrameAnimators=[];var e,f=b.animations.length;for(e=0;e<f;e++){var h=[];h.push(b.animations[e]);c.keyFrameAnimators.push(new Vizi.KeyFrameAnimator({animations:h}))}}d&&this.dispatchEvent("loaded",c)};Vizi.Loader.prototype.handleSceneProgress=function(a,b){this.dispatchEvent("progress",b)};
Vizi.Loader.prototype.convertScene=function(a){function b(a){if(a instanceof THREE.Mesh)return a.matrixAutoUpdate=!0,a.geometry.dynamic=!0,new Vizi.Visual({object:a});if(a instanceof THREE.Camera){if(a instanceof THREE.PerspectiveCamera)return new Vizi.PerspectiveCamera({object:a})}else if(a instanceof THREE.Light){if(a instanceof THREE.AmbientLight)return new Vizi.AmbientLight({object:a});if(a instanceof THREE.DirectionalLight)return new Vizi.DirectionalLight({object:a});if(a instanceof THREE.PointLight)return new Vizi.PointLight({object:a});
if(a instanceof THREE.SpotLight)return new Vizi.SpotLight({object:a})}else if(a.children){var d=new Vizi.Object({autoCreateTransform:!1});d.addComponent(new Vizi.Transform({object:a}));d.name=a.name;a.matrixAutoUpdate=!0;var e,f=a.children.length;for(e=0;e<f;e++){var h=b(a.children[e]);h instanceof Vizi.Object?d.addChild(h):h instanceof Vizi.Component&&d.addComponent(h)}}return d}a.updateMatrixWorld();return b(a)};Vizi.DirectionalLight=function(a){a=a||{};Vizi.Light.call(this,a);a.object?(this.object=a.object,this.direction=a.object.position.clone().negate()):(this.direction=a.direction||new THREE.Vector3(0,0,-1),this.object=new THREE.DirectionalLight(a.color,a.intensity,0))};goog.inherits(Vizi.DirectionalLight,Vizi.Light);Vizi.DirectionalLight.prototype.realize=function(){Vizi.Light.prototype.realize.call(this)};
Vizi.DirectionalLight.prototype.update=function(){this.position.copy(this.direction).negate();this.object.target.position.copy(this.direction).multiplyScalar(Vizi.Light.DEFAULT_RANGE);var a=this.object.parent.matrixWorld;this.position.applyMatrix4(a);this.object.target.position.applyMatrix4(a);Vizi.Light.prototype.update.call(this)};Vizi.PlaneDragger=function(a){Vizi.Picker.call(this,a)};goog.inherits(Vizi.PlaneDragger,Vizi.Picker);Vizi.PlaneDragger.prototype.realize=function(){Vizi.Picker.prototype.realize.call(this);this.projector=new THREE.Projector;this.dragObject=null;this.dragOffset=new THREE.Vector3;this.dragHitPoint=new THREE.Vector3;this.dragStartPoint=new THREE.Vector3;this.dragPlane=new THREE.Mesh(new THREE.PlaneGeometry(2E3,2E3,8,8),new THREE.MeshBasicMaterial({color:0}));this.dragPlane.visible=!1;this._object.transform.object.add(this.dragPlane)};
Vizi.PlaneDragger.prototype.update=function(){};Vizi.PlaneDragger.prototype.onMouseMove=function(a){if(a=Vizi.Graphics.instance.getObjectIntersection(a.elementX,a.elementY,this.dragPlane))this.dragHitPoint.copy(a.point).sub(this.dragOffset),this.dragHitPoint.add(this.dragStartPoint),this.dispatchEvent("drag",{type:"drag",object:this.dragObject,offset:this.dragHitPoint})};
Vizi.PlaneDragger.prototype.onMouseDown=function(a){Vizi.Picker.prototype.onMouseDown.call(this,a);var b=Vizi.Graphics.instance.getObjectIntersection(a.elementX,a.elementY,this.dragPlane);b&&(this.dragOffset.copy(b.point),this.dragStartPoint.set(0,0,0),this.dragStartPoint.applyMatrix4(a.object.object.matrixWorld),this.dragObject=a.object)};Vizi.ScaleBehavior=function(a){a=a||{};this.duration=void 0!==a.duration?a.duration:1;this.startScale=void 0!==a.startScale?a.startScale.clone():new THREE.Vector3(1,1,1);this.endScale=void 0!==a.endScale?a.endScale.clone():new THREE.Vector3(2,2,2);this.tween=null;Vizi.Behavior.call(this,a)};goog.inherits(Vizi.ScaleBehavior,Vizi.Behavior);
...
Vizi.ScaleBehavior.prototype.evaluate=function(a){a>=this.duration&&(this.stop(),this.loop?this.start():this.dispatchEvent("complete"));this._object.transform.scale.set(this.originalScale.x*this.scale.x,this.originalScale.y*this.scale.y,this.originalScale.z*this.scale.z)};Vizi.ScaleBehavior.prototype.stop=function(){this.tween&&this.tween.stop();Vizi.Behavior.prototype.stop.call(this)};Vizi.Viewer=function(a){Vizi.Application.call(this,a);this.lastFPSUpdateTime=0;this.renderStats={fps:0};this.sceneStats={meshCount:0,faceCount:0,boundingBox:new THREE.Box3};this.loopAnimations=void 0!==a.loopAnimations?a.loopAnimations:!1;this.headlightOn=void 0!==a.headlight?a.headlight:!0;this.firstPerson=void 0!==a.firstPerson?a.firstPerson:!1;this.showGrid=void 0!==a.showGrid?a.showGrid:!1;this.showBoundingBox=void 0!==a.showBoundingBox?a.showBoundingBox:!1;this.showBoundingBoxes=void 0!==a.showBoundingBoxes?
a.showBoundingBoxes:!1;this.allowPan=void 0!==a.allowPan?a.allowPan:!0;this.allowZoom=void 0!==a.allowZoom?a.allowZoom:!0;this.oneButton=void 0!==a.oneButton?a.oneButton:!1;this.gridSize=a.gridSize||Vizi.Viewer.DEFAULT_GRID_SIZE;this.gridStepSize=a.gridStepSize||Vizi.Viewer.DEFAULT_GRID_STEP_SIZE;this.flipY=void 0!==a.flipY?a.flipY:!1;this.highlightDecoration=this.highlightedObject=null;this.initScene();Vizi.Graphics.instance.enableShadows(!0)};goog.inherits(Vizi.Viewer,Vizi.Application);
Vizi.Viewer.prototype.initScene=function(){this.sceneRoot=new Vizi.Object;this.addObject(this.sceneRoot);this.flipY&&(this.sceneRoot.transform.rotation.x=-Math.PI/2);this.gridRoot=new Vizi.Object;this.addObject(this.gridRoot);this.gridPicker=this.grid=null;this.createGrid();this.firstPerson?(this.controller=Vizi.Prefabs.FirstPersonController({active:!0,headlight:!0}),this.controllerScript=this.controller.getComponent(Vizi.FirstPersonControllerScript)):(this.controller=Vizi.Prefabs.ModelController({active:!0,
headlight:!0,allowPan:this.allowPan,allowZoom:this.allowZoom,oneButton:this.oneButton}),this.controllerScript=this.controller.getComponent(Vizi.ModelControllerScript));this.addObject(this.controller);var a=new Vizi.Object;this.defaultCamera=new Vizi.PerspectiveCamera({active:!0});a.addComponent(this.defaultCamera);a.name="[default]";this.addObject(a);this.controllerScript.camera=this.defaultCamera;a=new Vizi.Object;this.ambientLight=new Vizi.AmbientLight({color:16777215,intensity:this.ambientOn?1:
0});this.addObject(a);this.scenes=[];this.keyFrameAnimators=[];this.keyFrameAnimatorNames=[];this.cameras=[];this.cameraNames=[];this.lights=[];this.lightNames=[];this.lightIntensities=[];this.lightColors=[];this.mouseCallbacks={}};
Vizi.Viewer.prototype.runloop=function(){Vizi.Application.prototype.runloop.call(this);if(Vizi.Graphics.instance.frameRate){var a=Date.now();1E3<a-this.lastFPSUpdateTime&&(this.renderStats.fps=Vizi.Graphics.instance.frameRate.toFixed(0),this.dispatchEvent("renderstats",this.renderStats),this.lastFPSUpdateTime=a)}};
Vizi.Viewer.prototype.replaceScene=function(a){var b,c=this.scenes.length;for(b=0;b<c;b++)this.sceneRoot.removeChild(this.scenes[b]);this.sceneRoot.removeComponent(this.sceneRoot.findNode(Vizi.Decoration));this.scenes=[a.scene];this.sceneRoot.addChild(a.scene);Vizi.SceneUtils.computeBoundingBox(a.scene);if(this.keyFrameAnimators){c=this.keyFrameAnimators.length;for(b=0;b<c;b++)this.sceneRoot.removeComponent(this.keyFrameAnimators[b]);this.keyFrameAnimators=[];this.keyFrameAnimatorNames=[]}if(a.keyFrameAnimators)for(c=
a.keyFrameAnimators.length,b=0;b<c;b++)this.sceneRoot.addComponent(a.keyFrameAnimators[b]),this.keyFrameAnimators.push(a.keyFrameAnimators[b]),this.keyFrameAnimatorNames.push(a.keyFrameAnimators[b].animationData[0].name);this.cameras=[];this.cameraNames=[];this.cameras.push(this.defaultCamera);this.camera=this.defaultCamera;this.cameraNames.push("[default]");this.controllerScript.camera=this.defaultCamera;this.controllerScript.camera.active=!0;if(a.cameras)for(c=a.cameras.length,b=0;b<c;b++){var d=
a.cameras[b];d.aspect=container.offsetWidth/container.offsetHeight;this.cameras.push(d);this.cameraNames.push(d._object.name)}this.lights=[];this.lightNames=[];this.lightIntensities=[];this.lightColors=[];if(a.lights){c=a.lights.length;for(b=0;b<c;b++)d=a.lights[b],d instanceof THREE.SpotLight&&(d.castShadow=!0,d.shadowCameraNear=1,d.shadowCameraFar=Vizi.Light.DEFAULT_RANGE,d.shadowCameraFov=90,d.shadowBias=1E-4,d.shadowDarkness=0.3,d.shadowMapWidth=2048,d.shadowMapHeight=2048,d.target.position.set(0,
0,0)),this.lights.push(a.lights[b]),this.lightNames.push(a.lights[b]._object.name),this.lightIntensities.push(a.lights[b].intensity),this.lightColors.push(a.lights[b].color.clone());this.controllerScript.headlight.intensity=c?0:1;this.headlightOn=0>=c}else this.controllerScript.headlight.intensity=1,this.headlightOn=!0;this.initHighlight();this.fitToScene();this.calcSceneStats()};
...
2048,d.shadowMapHeight=2048,d.target.position.set(0,0,0)),this.lights.push(a.lights[b]),this.lightNames.push(a.lights[b]._object.name),this.lightIntensities.push(a.lights[b].intensity),this.lightColors.push(a.lights[b].color.clone());this.scenes.push(a.scene);this.calcSceneStats()};
...
Vizi.Viewer.prototype.useCamera=function(a){var b=a;"string"==typeof a&&this.cameraNames&&(b=this.cameraNames.indexOf(a));0<=b&&(this.cameras&&this.cameras[b])&&(this.cameras[b].active=!0,this.controllerScript.enabled=0==b)};Vizi.Viewer.prototype.toggleLight=function(a){if(this.lights&&this.lights[a]){var b=this.lights[a];b instanceof Vizi.AmbientLight?(b=b.color,0!=b.r||0!=b.g||0!=b.b?b.setRGB(0,0,0):b.copy(this.lightColors[a])):b.intensity=b.intensity?0:this.lightIntensities[a]}};
...
Vizi.Viewer.prototype.stopAllAnimations=function(){if(this.keyFrameAnimators){var a,b=this.keyFrameAnimators.length;for(a=0;a<b;a++)this.keyFrameAnimators[a].stop()}};Vizi.Viewer.prototype.setLoopAnimations=function(a){this.loopAnimations=a};Vizi.Viewer.prototype.setHeadlightOn=function(a){this.controllerScript.headlight.intensity=a?1:0;this.headlightOn=a};Vizi.Viewer.prototype.setGridOn=function(a){this.grid&&(this.grid.visible=a)};
Vizi.Viewer.prototype.setBoundingBoxesOn=function(a){this.showBoundingBoxes=!this.showBoundingBoxes;var b=this;this.sceneRoot.map(Vizi.Decoration,function(a){b.highlightedObject&&a==b.highlightDecoration||(a.visible=b.showBoundingBoxes)})};Vizi.Viewer.prototype.setAmbientLightOn=function(a){this.ambientLight.intensity=a?1:0;this.ambientLightOn=a};
Vizi.Viewer.prototype.setFlipY=function(a){(this.flipY=a)?(this.sceneRoot.transform.rotation.x=-Math.PI/2,this.fitToScene()):this.sceneRoot.transform.rotation.x=0};Vizi.Viewer.prototype.initHighlight=function(){this.highlightedObject&&this.highlightedObject.removeComponent(this.highlightDecoration);this.highlightedObject=null};
Vizi.Viewer.prototype.highlightObject=function(a){this.highlightedObject&&this.highlightedObject._parent.removeComponent(this.highlightDecoration);if(a){var b=Vizi.SceneUtils.computeBoundingBox(a),c=new THREE.CubeGeometry(b.max.x-b.min.x,b.max.y-b.min.y,b.max.z-b.min.z),d=new THREE.MeshBasicMaterial({color:11184640,transparent:!1,wireframe:!0,opacity:1}),c=new THREE.Mesh(c,d);this.highlightDecoration=new Vizi.Decoration({object:c});a._parent.addComponent(this.highlightDecoration);b=b.max.clone().add(b.min).multiplyScalar(0.5);
this.highlightDecoration.position.add(b)}this.highlightedObject=a};
Vizi.Viewer.prototype.createGrid=function(){this.gridRoot&&(this.grid&&this.gridRoot.removeComponent(this.grid),this.gridPicker&&this.gridRoot.removeComponent(this.gridPicker));for(var a=this.gridStepSize,b=this.gridSize,c=new THREE.Geometry,d=0;d<=2*(b/a);d++)c.vertices.push(new THREE.Vector3(-b,-0.04,d*a-b)),c.vertices.push(new THREE.Vector3(b,-0.04,d*a-b)),c.vertices.push(new THREE.Vector3(d*a-b,-0.04,-b)),c.vertices.push(new THREE.Vector3(d*a-b,-0.04,b));a=new THREE.LineBasicMaterial({color:Vizi.Viewer.GRID_COLOR,
opacity:Vizi.Viewer.GRID_OPACITY});c=new THREE.Line(c,a,THREE.LinePieces);c.visible=this.showGrid;this.grid=new Vizi.Visual({object:c});this.gridRoot.addComponent(this.grid);this.gridPicker=new Vizi.Picker;var e=this;this.gridPicker.addEventListener("mouseup",function(a){e.highlightObject(null)});this.gridRoot.addComponent(this.gridPicker)};
Vizi.Viewer.prototype.fitToScene=function(){this.boundingBox=Vizi.SceneUtils.computeBoundingBox(this.sceneRoot);this.controllerScript.controls.userPanSpeed=1;1>this.boundingBox.max.z?(this.controllerScript.camera.near=0.01,this.controllerScript.controls.userPanSpeed=0.01):1E3<this.boundingBox.max.z&&(this.controllerScript.camera.far=2E4);var a=this.boundingBox.max.clone().add(this.boundingBox.min).multiplyScalar(0.5);this.controllerScript.center=a;a=new THREE.Vector3(0,this.boundingBox.max.y,2*this.boundingBox.max.z);
this.controllerScript.camera.position.copy(a);this.controllerScript.camera.position.z*=2;this.cameras[0].position.copy(this.controllerScript.camera.position);this.sceneRoot.map(Vizi.Object,function(a){if(a._parent){var c=Vizi.SceneUtils.computeBoundingBox(a),d=new THREE.CubeGeometry(c.max.x-c.min.x,c.max.y-c.min.y,c.max.z-c.min.z),e=new THREE.MeshBasicMaterial({color:65280,transparent:!0,wireframe:!0,opacity:0.2}),d=new THREE.Mesh(d,e),d=new Vizi.Decoration({object:d});a._parent.addComponent(d);a=
c.max.clone().add(c.min).multiplyScalar(0.5);d.position.add(a);d.visible=this.showBoundingBoxes}});this.sceneRadius=this.boundingBox.max.clone().sub(this.boundingBox.min).length();this.gridSize=a=Math.pow(10,Math.ceil(Math.log(this.sceneRadius)/Math.LN10));this.gridStepSize=a/100;this.createGrid()};
...
Vizi.Viewer.prototype.setController=function(a){var b=this.boundingBox.max.clone().add(this.boundingBox.min).multiplyScalar(0.5);switch(a){case "FPS":b.y=0}this.controllerScript.center=b};Vizi.Viewer.DEFAULT_GRID_SIZE=100;Vizi.Viewer.DEFAULT_GRID_STEP_SIZE=1;Vizi.Viewer.GRID_COLOR=2105376;Vizi.Viewer.GRID_OPACITY=0.2;Vizi.SpotLight=function(a){a=a||{};this.scaledDir=new THREE.Vector3;this.positionVec=new THREE.Vector3;this.castShadows=void 0!==a.castShadows?a.castShadows:Vizi.SpotLight.DEFAULT_CAST_SHADOWS;Vizi.Light.call(this,a);a.object?(this.object=a.object,this.direction=a.object.position.clone().normalize().negate(),this.targetPos=a.object.target.position.clone(),this.shadowDarkness=a.object.shadowDarkness):(this.direction=a.direction||new THREE.Vector3(0,0,-1),this.targetPos=new THREE.Vector3,this.shadowDarkness=
