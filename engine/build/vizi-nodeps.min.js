...
b(this,this.onDeviceOrientationChangeEvent),!1);this.freeze=!1};this.disconnect=function(){this.freeze=!0;window.removeEventListener("orientationchange",b(this,this.onScreenOrientationChangeEvent),!1);window.removeEventListener("deviceorientation",b(this,this.onDeviceOrientationChangeEvent),!1)};setObjectQuaternion=function(){var a=new THREE.Vector3(0,0,1),b=new THREE.Euler,e=new THREE.Quaternion,f=new THREE.Quaternion(-Math.sqrt(0.5),0,0,Math.sqrt(0.5));return function(k,m,g,l,h){this.roll||(Math.abs(h)==
Math.PI/2?g=0:h!=Math.PI&&(l=0));b.set(g,m,-l,"YXZ");k.setFromEuler(b);k.multiply(f);k.multiply(e.setFromAxisAngle(a,-h))}}()};Vizi.PlaneDragger=function(a){a=a||{};Vizi.Picker.call(this,a);this.normal=a.normal||new THREE.Vector3(0,0,1);this.position=a.position||new THREE.Vector3;this.color=170};goog.inherits(Vizi.PlaneDragger,Vizi.Picker);
